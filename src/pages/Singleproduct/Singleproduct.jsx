      ...
      <div className="product w-full h-[700px] flex flex-col gap-y-12">
        ...
        <div className="product__body w-full h-[43%] flex  relative">
          <div className=" w-[65%] h-[100%] flex flex-col relative">
            <div
              className="product__body--title w-full bg-[#FFFFFF] rounded-[15px] h-[15%] p-3 z-2"
              style={{ boxShadow: "0px 0px 20px rgba(0, 0, 0, 0.1)" }}
            >
              <h4 className="text-[#1C1C27] text-[20px] font-semibold">
                Описание и характеристики
              </h4>
            </div>
            <div
              className="w-full h-[75%] z-[-1] bg-[#F9F9F9] rounded-[15px] p-4 pt-11 absolute top-4"
              style={{ boxShadow: " 0px 0px 20px rgba(0, 0, 0, 0.1)" }}
            >
          ...
          <div className="product__buy w-[35%] h-[100%] flex flex-col items-center gap-7">
            <button
              ...
              className="w-[40%] h-[47px] text-white text-center text-[15px] font-medium bg-[#101010] rounded-[10px]"
            ...
            <button
              ...
              style={{ boxShadow: "0px 0px 15px rgba(0, 0, 0, 0.5)" }}
            >
              {saved ? "Удалить из корзины" : "Добавить в корзину"}
            </button>
          </div>
        </div>
      </div>
