      ...
      <div className="liked flex justify-center w-full h-screen">
        <div className="liked-wrapper w-[50%] h-full flex flex-col items-center justify-center gap-y-4">
          <span className="text-center">
            <h2 className="text-[30px] font-medium text-[#101010] font-sans">
              Упс пусто
            </h2>
            <p className="text-[20px] text-[#838383]">
              Но это никогда не поздно исправить :)
            </p>
          </span>
          <button
            className="w-[100%] h-[65px] text-white text-center bg-[#101010] rounded-[20px] font-semibold text-[17px]"
            onClick={() => navigate("/")}
